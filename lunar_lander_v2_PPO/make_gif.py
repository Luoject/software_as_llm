...
def save_gif_images(env_name, has_continuous_action_space, max_ep_len, action_std):
	...
	checkpoint_path = resolve_checkpoint_path(
		env_name, random_seed, run_num_pretrained, use_best=use_best_checkpoint
	)
...
def save_gif(env_name):
	...
	img_paths = img_paths[:total_timesteps]  # 只保存total_timesteps帧
	img_paths = img_paths[::step]  # 每隔step帧保存一次
